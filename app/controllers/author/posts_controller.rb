  ...
  class PostsController < AuthorController
    ...
    def create
      ...
      respond_to do |format|
        if @post.save
          format.html { redirect_to author_past_path(@post), notice: 'Post was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @post.update(post_params)
          format.html {  redirect_to author_past_path(@post), notice: 'Post was successfully updated.' }
